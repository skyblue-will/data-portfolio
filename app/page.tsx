...
const projects: Project[] = [
  ...
  },
  {
    ...
    seo: {
      ...
      ga4: "G-0H0F6XBV7T",
      notes: "ukhomeenergyguide.co.uk — DNS move to Vercel planned 16 Feb. /methodology page live. All 5 data sources cited on property pages.",
    },
    tasks: [
      { text: "E-E-A-T audit — /methodology page with formulas", done: true },
      { text: "Data source citations on all property pages", done: true },
      { text: "/affiliate-disclosure page", done: true },
      { text: "Non-commercial options alongside affiliates", done: true },
